    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form', models.CharField(choices=[(recycle.models.company.CompanyForm['PERSONAL'], 'PERSONAL'), (recycle.models.company.CompanyForm['PARTNERSHIP'], 'PARTNERSHIP'), (recycle.models.company.CompanyForm['JOINT_STOCK'], 'JOINT-STOCK'), (recycle.models.company.CompanyForm['LIMITED'], 'LIMITED')], max_length=32, verbose_name='企业类型')),
